...
import 'debug_overlay_panel.dart';
import 'http_request_detail_sheet.dart';
import 'network/network_debug_bus.dart';
import 'widget/ws_detail_sheet.dart';
...
class _DraggableDebugOverlayState extends State<DraggableDebugOverlay> with SingleTickerProviderStateMixin {
  ...
  Future<void> _openHttpDetail(NetworkLogEntry entry) async {
    ...
    await showModalBottomSheet(
      ...
      builder: (_) => HttpRequestDetailSheet(entry: entry),
    );
  ...
  Future<void> _openWsDetail(WsLogEvent event) async {
    ...
    await showModalBottomSheet(
      ...
      builder: (_) => WsDetailSheet(event: event),
    );
        ...
        return SizedBox.expand(
          child: Stack(
            ...
            children: [
              ...
              if (_panelVisible)
                Positioned(
                  ...
                  child: _MovableOverlayPanel(
                    ...
                    child: widget.panelBuilder?.call(context) ??
                        DebugOverlayPanel(
              ...
              if (!_panelVisible && !_detailVisible)
                Positioned(
